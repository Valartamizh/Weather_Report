...
public class WeatherController {
    ...
    @GetMapping("/filter")
    @Operation(
            summary = "Advanced weather filtering",
            description = "Filter weather data by temperature range, humidity range with pagination and sorting."
    )
    public ResponseEntity<List<WeatherDto>> filterWeather(
